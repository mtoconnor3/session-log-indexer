...
| **Hooks** | None — tools are agent-triggered only | Agent controls what to index and when |
| **Current session** | Not indexed | Agent controls what to index; current session may still be in progress |
